...
var (
	...
	mustPassTests = []_test{
		...
		{"000000000000000a" + "74657374537472696e67", "testString"},
		{hexS, s},
		{hexS, &s},
		{"00000001000200030004", [5]uint16{0, 1, 2, 3, 4}},
		{"000000000000000500000001000200030004", []uint16{0, 1, 2, 3, 4}},
		{"0000000000000001" + "0000000000000001610001", map[string]uint16{"a": 1}},
	}
	mustFailTests = []_test{
		{"", make(chan int, 1)},
		{"", func() {}},
